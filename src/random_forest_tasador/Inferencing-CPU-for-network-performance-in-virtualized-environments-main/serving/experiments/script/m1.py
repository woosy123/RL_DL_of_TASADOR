...
dataset = pd.read_csv('./data/m1,m2/m1_train.csv', names=['packet_size', 'bandwidth_tx', 'cpu_usage'], delimiter=',')
...
input_df = pd.read_csv('./data/m1,m2/m1_input.csv', names=['packet_size', 'bandwidth_tx'])
...
with open('./data/m1,m2/m2_input.csv','w', newline="") as f:
...
'''
dataset = pd.read_csv('./data/m1,m2/m1_train.csv', names=['packet_size', 'bandwidth_tx', 'cpu_usage'])
...
with open('./data/m1,m2/m2_input_rmsle.csv','w', newline="") as f:
    makewrite = csv.writer(f)
    for i in range(len(pred_y)):
        # 'packet_size', 'bandwidth_tx', 'pps_tx', 'cpu_usage'
